      ...
      <header>
        ...
        <nav class="navbar" aria-label="">
          ...
          <ul class="menu-links">
            ...
            <li class="join-btn"><a href="../php/signup.php">Signup</a></li>
...
?>
        ...
        <div class="middle">
          <img class="middleImg" src="../img/bg8.jpg" alt="">
        ...
        <div class="container">
            ...
            <ul class="pagination pagination-sm">
              ...
              <li class="page-item"><a class="page-link" href="../html/index.html">1</a></li>
              ...
              <li class="page-item">
                <a class="active" href="../html/login.html" aria-label="Next">
