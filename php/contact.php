...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO `contact` (`username`, `email`, `massage`) VALUES ('$username', '$email', '$message')";
...
<body>
  ...
  <div class="middle">
    <img class="middleImg" src="../img/Youchiro.jpg" alt="">
    <h2 class="question">Have a question for us? Fill out this form below:</h2>
    <form class="form" method="POST" action="contact.php">
      <div class="form-group">
        <label class="label" for="exampleInputPassword1">Username</label>
        <input type="text" name="username" class="form-control" id="exampleInputPassword1" placeholder="Name & Surname">
      </div>
      <div class="form-group">
        <label class="label" for="exampleInputEmail1">Email address</label>
        <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
          placeholder="Enter email">
        <small class="label" id="emailHelp" class="form-text text-muted">We'll never share your email with anyone
          else.</small>
      </div>
      <div class="form-group">
        <label class="label" for="exampleInputPassword1">Message or Question</label>
        <textarea name="message" class="form-control" id="exampleInputPassword1" placeholder="Your message"></textarea>
      </div>
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="exampleCheck1">
        <label class="label" class="form-check-label" for="exampleCheck1">Check me out</label>
      </div>
  ...
  <footer>
    ...
    <div class="footer2">
      <div class="content">
        <div class="left box">
          <div class="upper">
            ...
            <H6>At MangaDub, we are passionate about bringing the captivating world of manga to fans around the globe.
            </H6>
          </div>
          <div class="lower">
        ...
        <div class="right box">
          ...
          <form action="Premium.html">
            ...
            <div class="media-icons">
              <a href="https://www.facebook.com/profile.php?id=100029734134219&sk=about"><i
      ...
      <div class="bottom">
        <p class="copyright">
          <small>&copy; 2023 <a href="../html/index.html">MangaDub </a>All rights reserved</small>
        </p>
      </div>
  </footer>
